...
**v0.13.1** — established 2026-05-20 (Patch — Three v0.13.0 follow-up fixes from Mauricio's smoke test).
...
window.__GA_BUILD__
```
Should return the build marker string (current: `"2026-05-20-v0131-deep-link-fixes"`). If `undefined`, the new bundle didn't deploy — likely an upload location issue.
