...
import { HeroVisual, LOTTIE_HERO_URL, Login } from "./pages/landing";
...
if(typeof window!=="undefined"){window.__GA_BUILD__="2026-06-11-v0740-plan-ladder-premium-gating";console.log("%c⚓ Golden Anchor build:","color:#D4A017;font-weight:bold",window.__GA_BUILD__);}
