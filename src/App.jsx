...
if(typeof window!=="undefined"){window.__GA_BUILD__="2026-07-01-v08357-promo-apr0-end-date-i18n-months";console.log("%c⚓ Golden Anchor build:","color:#D4A017;font-weight:bold",window.__GA_BUILD__);}
...
{[
  ...
  <button onClick={()=>tabRowRef.current?.scrollBy({left:260,behavior:"smooth"})} title={t.scrollTabsRight||"Scroll tabs right"} aria-label={t.scrollTabsRight||"Scroll tabs right"} disabled={!canScrollR} style={{flexShrink:0,width:28,height:36,display:"flex",alignItems:"center",justifyContent:"center",background:canScrollR?th.card:"transparent",border:canScrollR?`1px solid ${th.cardBorder}`:"1px solid transparent",borderBottom:"none",color:canScrollR?th.text:th.dim,cursor:canScrollR?"pointer":"default",opacity:canScrollR?1:0.3,fontSize:14,lineHeight:1,padding:0,borderRadius:"6px 6px 0 0"}}>›</button>
