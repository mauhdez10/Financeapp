...
if(typeof window!=="undefined"){window.__GA_BUILD__="2026-06-24-v0821-clientlist-windowed-render";console.log("%c⚓ Golden Anchor build:","color:#D4A017;font-weight:bold",window.__GA_BUILD__);}
