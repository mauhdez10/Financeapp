...
function ClientList({clients,t,onSelect,onAdd,onRestore,onImportNew,onRestoreBackup,onArchiveMany,onRestoreMany,onDeleteMany,onSplit,onJoin}){
  ...
  return <div style={{padding:isMobile?14:24}}>
    ...
    <div style={{display:"flex",alignItems:"center",justifyContent:"flex-end",gap:8,marginBottom:14,flexWrap:isMobile?"wrap":"nowrap"}}>
      <input placeholder={"🔍 "+(t.searchClients||"Search...")} value={search} onChange={e=>setSearch(e.target.value)} style={{...mINP(th),flex:isMobile?"1 1 100%":"1 1 320px",minWidth:0,padding:"7px 12px",fontSize:12,boxSizing:"border-box"}}/>
      <select value={sortBy} onChange={e=>setSortBy(e.target.value)} title={t?.sortBy||"Sort by"} style={{...mINP(th),padding:"7px 10px",fontSize:11,fontWeight:600,cursor:"pointer",flex:"0 0 auto"}}>
...
if(typeof window!=="undefined"){window.__GA_BUILD__="2026-05-22-v0250-clients-header-trend-row-kebab-subtab-wrap-services-fit";console.log("%c⚓ Golden Anchor build:","color:#D4A017;font-weight:bold",window.__GA_BUILD__);}
