...
if(typeof window!=="undefined"){window.__GA_BUILD__="2026-06-27-v08347-es-missing-key-fallbacks";console.log("%c⚓ Golden Anchor build:","color:#D4A017;font-weight:bold",window.__GA_BUILD__);}
