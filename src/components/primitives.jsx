...
// a11y helper (WCAG 4.1.2) — resolve a localized label from the active <html lang>
// for shared primitives (Modal / IAdd close buttons) that don't receive `t`. The
// app keeps documentElement.lang in sync with the language state (v0.83.12), so an
// icon-only button gets an accessible name in EN or ES without threading t props.
